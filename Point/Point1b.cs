...
namespace Point1b {
    ...
    class TestPoint {
        public static void Mainx() {
            ...
            Point bod2 = new Point(30.665, 516.564);
            Console.WriteLine(bod2.getX().ToString() + " " + bod2.getY());
            bod2.setY(10.999);
            Console.WriteLine(bod2.getY());
            Console.WriteLine(kruh2.Center);
        }
    }
}
