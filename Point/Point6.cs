...
namespace Point6 {
	...
	class TestPoint {
		public static void Mainx() {
			...
			Shape[] tvary = new Shape[] {kruh1, kruh2, kruh3, kruh10, obd1, obd2, obd3, obd4, rec1 };
			...
			Console.WriteLine("Součet obvodů všech kruhů a obdélníků je " + soucetObvodu);

			List<Shape> tvaryList = new List<Shape>() { kruh1, kruh2, kruh3, kruh10, obd1, obd2, obd3, obd4, rec1 };

			foreach(Shape item in tvaryList) {
				soucetObvodu2 += item.perimeter();
			}
			Console.WriteLine("Součet obvodů všech kruhů a obdélníků z Listu je " + soucetObvodu2);

			ArrayList tvaryArrayList = new ArrayList() { kruh1, kruh2, kruh3, kruh10, obd1, obd2, obd3, obd4, rec1 };
			foreach(Shape item in tvaryArrayList) {
				soucetObvodu3+= item.perimeter();
			}
			Console.WriteLine("Součet obvodů všech kruhů a obdélníků z ArrayListu je " + soucetObvodu3);
		}
	}
}
