...
namespace Prvni5b {
	...
	class Student : Person {
		...
		//public Student(int age) {   pri volani tohoto konsteuktoru se deklaruje datova slozka scholarship ale inicializuje se implicitne na nulu, stejne string na "" atd.
		//	this.age = age;
		//}
		//public Student(int scholarship) {    nejde vytvorit 2 konstruktory se stejnou signaturou (stejny pocet param., stejny datovy typ param
		//	this.scholarship = scholarship;	
		//}
